...
- DONE  并发的八股
  ...
  collapsed:: true
	...
	- 线程与线程组的关系，以及JVM与操作系统的线程优先级的关系#card
	  card-last-interval:: 4
	  card-repeats:: 1
	...
	- 什么是happen-before 规则，这个规则要怎么遵循，有什么用#card
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.36
	...
	- 为什么volatile 可以保证线程可见性且提供了一定的有序性，但是无法保证原子性？JVM是怎么实现他的#card
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
	...
	- synchronize 关键字属于什么锁，一般怎么用，可以锁些什么，能解决并发的哪些问题#card
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
	...
	- synchronize 的锁的四种状态及其转换条件#card
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
	...
	- ReentrantLock 与 Synchronize 的区别 #card
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
