...
- DONE JVM内存模型和其他相关知识  
  ...
  collapsed:: true
	...
	- 什么是栈帧，作用是什么，组成是什么，与栈的关系是什么，与线程的关系是什么 #card
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
...
- DONE  电商运营平台
  ...
  :END:
	- INSERT INTO student (id, name, age) VALUES (4, 'Bob', 23) ON DUPLICATE KEY UPDATE name = 'Bob'的限制、影响和额外加锁 #card #mysql
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
	  ...
	  id:: 6821b299-89aa-48e4-95f2-569cd341b37b
		...
		- 会发生主键跳跃
	- 为什么bigdecimal可以避免精度损失？#card #Java基础
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
	...
	- 包装类型与基本类型的关系，什么时候会进行自动装拆箱 #card #Java基础
	  card-last-interval:: 4
	  card-repeats:: 1
	  card-ease-factor:: 2.6
